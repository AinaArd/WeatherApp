                ...
                .enqueue(new Callback<WeatherResponse>() {
                    ...
                    public void onResponse(@NonNull Call<WeatherResponse> call, @NonNull Response<WeatherResponse> response) {
                        ...
                        if (weatherResponse != null) {
                            ...
                            List<City> cacheCities = new ArrayList<>();
/*
                            Observable<List<WeatherResponse>> network = (Observable<List<WeatherResponse>>) cities;
                            Observable<List<WeatherResponse>> cache = (Observable<List<WeatherResponse>>) cacheCities;

                            Observable.concat(cache, network)
                                    .filter(list -> !list.isEmpty())
                                    .first((Func1<? super List<WeatherResponse>, Boolean>) Collections.emptyList())
                                    .subscribe();*/
